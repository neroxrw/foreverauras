      ...
      if self.activeMask == "secret" or true then
        ...
        for index, additionalBar in ipairs(self.additionalBars) do
          ...
          if not abar then
            ...
            abar.textureMask:SetTexture("Interface\\AddOns\\ForeverAuras\\Media\\Textures\\Square_FullWhite",
            ...
            abar.offsetBar1:SetStatusBarTexture("Interface\\AddOns\\ForeverAuras\\Media\\Textures\\Square_FullWhite");
          ...
          elseif direction and width then
            ...
            if not abar.offsetBarAdditional then
              ...
              abar.offsetBarAdditional:SetStatusBarTexture("Interface\\AddOns\\ForeverAuras\\Media\\Textures\\Square_FullWhite");
...
local function create(parent)
  ...
  secretBar:SetStatusBarTexture("Interface\\AddOns\\ForeverAuras\\Media\\Textures\\Square_FullWhite");
  secretBar:SetColorFill(1, 1, 1, 0);
  local secretBarMask = bar:CreateMaskTexture()
  secretBarMask:SetTexture("Interface\\AddOns\\ForeverAuras\\Media\\Textures\\Square_FullWhite",
                    "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE", "NEAREST")
  ...
  fgMask:SetTexture("Interface\\AddOns\\ForeverAuras\\Media\\Textures\\Square_FullWhite",
                    "CLAMPTOBLACKADDITIVE", "CLAMPTOBLACKADDITIVE", "NEAREST")
