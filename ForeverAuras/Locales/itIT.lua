...
Copy the whole text to Weakaura's Discord if you need assistance.]=] ] = "Una panoramica dettagliata delle tue aure e dei sistemi ForeverAuras, Copia l'intero testo su Discord di Weakaura se hai bisogno di assistenza."
--[[Translation missing --]]
...
--[[Translation missing --]]
L["Copper"] = "Copper"
L["Could not load ForeverAuras Archive, the addon is %s"] = "Impossibile caricare l'archivio ForeverAuras, il componente aggiuntivo è %s"
L["Count"] = "Conteggio "
...
--[[Translation missing --]]
L["Malformed ForeverAuras link"] = "Malformed ForeverAuras link"
--[[Translation missing --]]
L["Manual"] = "Manual"
--[[Translation missing --]]
