...
L["Copper"] = "銅"
L["Could not load ForeverAuras Archive, the addon is %s"] = "無法載入ForeverAuras Archive，此插件為 %s"
L["Count"] = "數量"
...
L["Error decompressing. This doesn't look like a ForeverAuras import."] = "解壓縮時出錯，這看起來不像是 ForeverAuras 的匯入字串。"
...
L["Malformed ForeverAuras link"] = "格式錯誤的 ForeverAuras 連結"
L["Manual"] = "手動"
L["Manual Icon"] = "手動圖示"
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the ForeverAuras Discord server for help."] = "這個過濾方式已經移動到位置觸發器。請更改您的提醒效果以使用新的位置觸發器，或加入 ForeverAuras Discord 伺服器尋求幫助。"
...
L["True"] = "是 (True)"
L["Trying to repair broken conditions in %s likely caused by a ForeverAuras bug."] = "嘗試修復 %s 中可能是由 ForeverAuras 的 bug 引起的損壞狀況。"
L["Twin Emperors"] = "雙子皇帝"
L["Type"] = "類型"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration."] = "無法更新提醒效果 ‘%s’。可能是由於資料損壞或不良遷移所致，請向 ForeverAuras 團隊報告此問題。"
L["Unaffected"] = "未受影響"
L["Undefined"] = "未定義"
L["Unholy"] = "穢邪"
...
L["ForeverAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "ForeverAuras 正在建立提醒效果的還原快照。如果出現問題，此快照將允許您恢復到提醒效果目前的狀態。此過程可能會導致幀速下降，直到完成為止。"
L["ForeverAuras Profiling"] = "ForeverAuras 效能分析"
L["ForeverAuras Profiling Report"] = "ForeverAuras 分析報告"
...
L["Writing to the ForeverAuras table is not allowed."] = "不允許寫入 ForeverAuras table。"
L["X-Offset"] = "水平位移"
L["Yell"] = "大喊"
L["Y-Offset"] = "垂直位移"
