...
L["Copper"] = "Cobre"
L["Could not load ForeverAuras Archive, the addon is %s"] = "No se pudo cargar ForeverAuras Archive, el addon está %s"
L["Count"] = "Recuento"
...
L["Malformed ForeverAuras link"] = "Enlace ForeverAuras malformado"
L["Manual"] = "Manual"
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the ForeverAuras Discord server for help."] = "Este filtro ha sido trasladado al disparador de ubicación. Cambia tu aura para utilizar el nuevo disparador de ubicación o únete al servidor de Discord de ForeverAuras para obtener ayuda."
...
|cffff0000You should BACKUP your WTF folder BEFORE pressing this button.|r]=] ] = "ForeverAuras ha detectado que ha sido degradado. Es posible que tus auras guardadas ya no funcionen correctamente. ¿Te gustarías ejecutar la herramienta de reparación |cffff0000EXPERIMENTAL|r? Esto sobrescribirá cualquier cambio que haya realizado desde la última actualización de la base de datos. Última actualización: %s |cffff0000Debes HACER UNA COPIA DE SEGURIDAD de tu carpeta WTF ANTES de presionar este botón.|r"
L["ForeverAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "ForeverAuras está creando una instantánea de reversión de tus auras. Esta instantánea te permitirá volver al estado actual de tus auras si algo sale mal. Este proceso puede hacer que tu tasa de fotogramas disminuya hasta que se complete."
L["ForeverAuras Profiling"] = "Perfilado de ForeverAuras"
L["ForeverAuras Profiling Report"] = "Informe de perfilado de ForeverAuras"
L["ForeverAuras Version: %s"] = "ForeverAuras Versión: %s"
L["Weapon"] = "Arma"
