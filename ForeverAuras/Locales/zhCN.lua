...
L["Armor Peneration Percent"] = "破甲率"
...
L["Assist"] = "团队助理"
L["Assisted Combat Next Cast"] = "一键辅助下个法术"
...
L["Copper"] = "铜"
L["Could not load ForeverAuras Archive, the addon is %s"] = "无法载入ForeverAuras Archive：%s"
L["Count"] = "计数"
...
L["Error decompressing. This doesn't look like a ForeverAuras import."] = "解压错误。这不像一个ForeverAuras导入字符串。"
...
L["Lua error"] = "Lua错误"
L["Lua error in Aura '%s': %s"] = "光环 '%s' Lua错误 : %s"
L["Lucifron"] = "鲁西弗隆"
L["Maexxna"] = "迈克斯纳"
L["Magic"] = "魔法"
L["Magmadar"] = "玛格曼达"
...
L["Malformed ForeverAuras link"] = "错误的 ForeverAuras 链接"
L["Manual"] = "手动"
L["Manual Icon"] = "手动图标"
...
L["Select Frame"] = "选择框体"
L["Select the type of timer to filter"] = "选择计时器类型过滤"
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the ForeverAuras Discord server for help."] = "此过滤器已经被移动到位置过滤器。修改你的光环以使用新的位置过滤器，或者加入ForeverAuras Discord寻求帮助。"
...
L["True"] = "真"
L["Trying to repair broken conditions in %s likely caused by a ForeverAuras bug."] = "正在尝试修复由ForeverAuras的Bug导致的，%s的损坏条件。"
L["Twin Emperors"] = "双子皇帝"
L["Type"] = "类型"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration."] = "无法现代化光环'%s'。这个可能是因为数据错误或者升级流程错误，请报告给ForeverAuras团队。"
L["Unaffected"] = "未受影响"
L["Undefined"] = "未定义"
L["Unholy"] = "邪恶"
...
L["ForeverAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "ForeverAuras 正在创建您的光环的回滚快照。如果出现问题，此快照将允许恢复到光环的当前状态。此过程在其完成前可能会导致您的帧率下降。"
L["ForeverAuras Profiling"] = "ForeverAuras性能分析"
L["ForeverAuras Profiling Report"] = "ForeverAuras性能分析报告"
L["ForeverAuras Version: %s"] = "ForeverAuras 版本：%s"
L["Weapon"] = "武器"
...
L["Writing to the ForeverAuras table is not allowed."] = "写入ForeverAuras表是不被允许的。"
L["X-Offset"] = "X 偏移"
L["Yell"] = "大喊"
L["Y-Offset"] = "Y 偏移"
