...
--@localization(locale="ruRU", format="lua_additive_table", namespace="ForeverAuras", handle-subnamespaces="none")@
-- ForeverAuras
...
L["Could not load ForeverAuras Archive, the addon is %s"] = "Не удалось загрузить ForeverAuras Archive. Причина - %s"
L["Count"] = "Количество"
...
L["Error decompressing. This doesn't look like a ForeverAuras import."] = "Ошибка распаковки. Это не похоже на строку импорта ForeverAuras"
...
L["Malformed ForeverAuras link"] = "Неверная ссылка ForeverAuras"
L["Malygos"] = "Малигос"
--[[Translation missing --]]
L["Manual"] = "Manual"
--[[Translation missing --]]
...
L["Options could not be loaded, the addon is %s"] = "Не удалось загрузить ForeverAuras Options. Причина - %s"
...
L["True"] = "Истина"
L["Trying to repair broken conditions in %s likely caused by a ForeverAuras bug."] = "Попытка восстановить поврежденные условия в индикации %s, причиной которых стала ошибка аддона."
...
L["ForeverAuras has encountered an error during the login process. Please report this issue at https://github.com/WeakAuras/WeakAuras2/issues/new."] = "Во время процесса входа в игру возникла ошибка. Пожалуйста, сообщите об этой проблеме по адресу https://github.com/WeakAuras/WeakAuras2/issues/new."
L["ForeverAuras Profiling"] = "Профилирование ForeverAuras"
L["ForeverAuras Profiling Report"] = "Отчёт профилирования"
L["ForeverAuras Version: %s"] = "Версия ForeverAuras: %s"
L["Weapon"] = "Оружие"
...
L["Writing to the ForeverAuras table is not allowed."] = "Запись в таблицу ForeverAuras запрещена."
