...
L["Copper"] = "코퍼"
L["Could not load ForeverAuras Archive, the addon is %s"] = "ForeverAuras Archive를 불러올 수 없습니다. 애드온이 %s 상태입니다"
L["Count"] = "개수"
...
L["Error decompressing. This doesn't look like a ForeverAuras import."] = "압축을 푸는 중 오류가 발생했습니다. ForeverAuras 가져오기 문자열이 아닙니다."
...
L["Malformed ForeverAuras link"] = "잘못된 ForeverAuras 링크"
L["Manual"] = "수동 설정"
...
L["This filter has been moved to the Location trigger. Change your aura to use the new Location trigger or join the ForeverAuras Discord server for help."] = "이 필터는 위치 활성 조건으로 이전됐습니다. 새로운 위치 활성 조건을 사용하려면 위크오라를 수정하시고 잘 모르겠으면 ForeverAuras Discord 서버에 접속해서 도움을 요청하세요."
...
L["True"] = "참"
L["Trying to repair broken conditions in %s likely caused by a ForeverAuras bug."] = "%s에서 ForeverAuras 버그로 인해 망가진 조건 복구를 시도중입니다."
L["Twin Emperors"] = "쌍둥이 제왕"
L["Type"] = "종류"
L["Unable to modernize aura '%s'. This is probably due to corrupt data or a bad migration."] = "'%s' 위크오라를 현대화할 수 없습니다. 데이터 오염이나 마이그레이션에 문제가 있는 것 같습니다. 이 내역을 ForeverAuras 팀에 제보해 주세요."
...
L["ForeverAuras is creating a rollback snapshot of your auras. This snapshot will allow you to revert to the current state of your auras if something goes wrong. This process may cause your framerate to drop until it is complete."] = "ForeverAuras가 보유한 위크오라의 롤백 스냅샷을 생성중입니다. 위크오라에 문제가 발생할 경우 이 스냅샷을 통해 현재 상태의 위크오라로 복원할 수 있습니다. 작업이 완료될 때까지 프레임드랍이 발생할 수 있습니다."
L["ForeverAuras Profiling"] = "ForeverAuras 성능 분석"
L["ForeverAuras Profiling Report"] = "ForeverAuras 성능 분석 보고서"
L["ForeverAuras Version: %s"] = "ForeverAuras 버전: %s"
L["Weapon"] = "무기"
...
L["Writing to the ForeverAuras table is not allowed."] = "ForeverAuras 테이블에 작성하는 행위는 허용되지 않습니다."
L["X-Offset"] = "X-위치 조정"
L["Yell"] = "외침"
L["Y-Offset"] = "Y-위치 조정"
