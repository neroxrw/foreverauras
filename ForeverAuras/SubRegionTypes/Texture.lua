...
local default = function(parentType)
  local defaults = {
    ...
    textureTexture = "Interface\\Addons\\ForeverAuras\\PowerAurasMedia\\Auras\\Aura3",
...
ForeverAuras.RegisterSubRegionType("subtexture", L["Texture"], supports, create, modify, onAcquire, onRelease, default, nil, properties)
