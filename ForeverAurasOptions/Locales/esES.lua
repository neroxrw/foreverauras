...
Off Screen]=] ] = "El aura está fuera de la pantalla"
	...
	L["Chat with ForeverAuras experts on our Discord server."] = "Chatea con los expertos de ForeverAuras en nuestro servidor Discord."
	L["Check On..."] = "Chequear..."
...
Upgrade your version of ForeverAuras or wait for next release before installing this aura.]=] ] = "Esta aura fue creada con una versión más nueva de ForeverAuras. Actualiza tu versión de ForeverAuras o espera la próxima versión antes de instalar esta aura."
	...
	L["ForeverAuras %s on WoW %s"] = "ForeverAuras %s en WoW %s"
	L["ForeverAuras recommends using spell ids instead of names. Spell ids are automatically localized."] = "ForeverAuras recomienda usar IDs de hechizos en lugar de nombres. Los IDs de hechizos se localizan automáticamente."
