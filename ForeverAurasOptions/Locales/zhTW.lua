...
跑出畫面]=]
	...
	L["Changelog"] = "更新紀錄"
	L["Chat with ForeverAuras experts on our Discord server."] = "在我們的 Discord 伺服器和 ForeverAuras 專家們聊天。"
	L["Check On..."] = "檢查..."
...
從第二到第十一次事件開始每三次事件：2-11/3]=]
	...
	L["Requires LibSpecialization, that is e.g. a up-to date ForeverAuras version"] = "需要 LibSpecialization，也就是最新的 ForeverAuras 版本"
...
安裝這個提醒效果之前，請先升級你的 ForeverAuras 版本，或是等待下次發佈更新。]=]
	...
	L["We thank"] = "我們感謝"
	L["ForeverAuras %s on WoW %s"] = "ForeverAuras %s 在 WoW %s"
	L["ForeverAuras recommends using spell ids instead of names. Spell ids are automatically localized."] = "ForeverAuras 建議使用法術ID而不是名稱。法術ID會自動本地化。"
