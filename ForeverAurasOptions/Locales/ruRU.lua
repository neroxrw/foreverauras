...
L["Chat with ForeverAuras experts on our Discord server."] = "Общайтесь со знатоками ForeverAuras на нашем сервере Discord."
...
L["ModelPaths could not be loaded, the addon is %s"] = "Не удалось загрузить ForeverAuras Model Paths. Причина - %s"
...
L["Requires LibSpecialization, that is e.g. a up-to date ForeverAuras version"] = "Требуется LibSpecialization, т.е. актуальная версия ForeverAuras"
...
L["Templates could not be loaded, the addon is %s"] = "Не удалось загрузить ForeverAuras Templates. Причина - %s"
...
L["Voice"] = "Голос"
L["ForeverAuras %s on WoW %s"] = "ForeverAuras: %s. Интерфейс: %s"
