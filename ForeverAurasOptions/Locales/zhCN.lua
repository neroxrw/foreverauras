...
Off Screen]=] ] = "光环在屏幕外"
	...
	L["Changelog"] = "更新日志"
	L["Chat with ForeverAuras experts on our Discord server."] = "在我们的Discord服务器上与ForeverAuras专家聊天。"
	L["Check On..."] = "检查..."
...
从第二到第十一次事件开始每三次事件：2-11/3]=]
	...
	L["Requires LibSpecialization, that is e.g. a up-to date ForeverAuras version"] = "需要LibSpecialization，可从最新的ForeverAuras版本中获取。"
...
在导入此光环前，请更新ForeverAuras版本或等待下次发布。]=]
	...
	L["ForeverAuras recommends using spell ids instead of names. Spell ids are automatically localized."] = "WA建议使用法术id而不是法术名称。法术id会自动本地化。"
