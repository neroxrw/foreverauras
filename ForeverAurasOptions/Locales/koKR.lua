...
Off Screen]=] ] = "위크오라가 화면 밖에 있습니다"
	...
	L["Changelog"] = "업데이트 내역"
	L["Chat with ForeverAuras experts on our Discord server."] = "우리의 Discord 서버에서 ForeverAuras 전문가들과 이야기를 나누어 보세요."
	L["Check On..."] = "상태 확인 시점..."
...
2번부터 11번까지 이벤트 중 3개의 이벤트마다: 2-11/3]=]
	...
	L["Requires LibSpecialization, that is e.g. a up-to date ForeverAuras version"] = "LibSpecialization이 필요하며, ForeverAuras 버전을 최신으로 유지하면 됩니다."
	...
	L["The ForeverAuras Options Addon version %s doesn't match the ForeverAuras version %s. If you updated the addon while the game was running, try restarting World of Warcraft. Otherwise try reinstalling ForeverAuras"] = "ForeverAuras Options 애드온 %s 버전이 ForeverAuras %s 버전과 맞지 않습니다. 게임을 실행한 상태에서 애드온을 업데이트 했다면 월드 오브 워크래프트를 종료 후 다시 실행하세요. 그래도 안되면 ForeverAuras를 다시 설치해 보시기 바랍니다."
	L["Then "] = "Then"
...
Upgrade your version of ForeverAuras or wait for next release before installing this aura.]=] ] = "이 위크오라는 보다 최신 버전의 ForeverAuras로 제작되었습니다. ForeverAuras 버전을 업그레이드하거나 이 위크오라를 설치하지 말고 다음 릴리즈를 기다리세요."
	...
	L["We thank"] = "감사합니다"
	L["ForeverAuras %s on WoW %s"] = "ForeverAuras %s (WoW %s)"
	L["ForeverAuras recommends using spell ids instead of names. Spell ids are automatically localized."] = "ForeverAuras는 주문 이름 대신 주문 ID 사용을 권장합니다. 주문 ID는 언어에 맞게 자동 번역됩니다."
