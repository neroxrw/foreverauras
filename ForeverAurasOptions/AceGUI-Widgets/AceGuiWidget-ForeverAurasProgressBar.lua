...
-------------------------------------------------------------------------------]]
local Type, Version = "ForeverAurasProgressBar", 2
...
local function Constructor()
  ...
  foreground:SetTexture("Interface\\AddOns\\ForeverAuras\\Media\\Textures\\Square_White")
  background:SetTexture("Interface\\AddOns\\ForeverAuras\\Media\\Textures\\Square_White")
