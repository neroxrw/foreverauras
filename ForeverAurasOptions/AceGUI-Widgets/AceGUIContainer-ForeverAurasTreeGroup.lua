...
--[[-----------------------------------------------------------------------------
ForeverAurasTreeGroup Container
Container that uses a tree control to switch between groups.
This file was forked from AceGUIContainer-TreeGroup.lua version 41
-------------------------------------------------------------------------------]]
if not ForeverAuras.IsLibsOK() then return end

local Type, Version = "ForeverAurasTreeGroup", 3
local AceGUI = LibStub and LibStub("AceGUI-3.0", true)
if not AceGUI or (AceGUI:GetWidgetVersion(Type) or 0) >= Version then return end

local WoW80 = true -- Forever uses the modern frame positioning path.
...
local function Constructor()
	...
	local treeframeBG = CreateFrame("Frame", nil, treeframe, "BackdropTemplateForeverAuras")
	...
	local dragger = CreateFrame("Frame", nil, treeframe, "BackdropTemplateForeverAuras")
	dragger:SetWidth(8)
	...
	local border = CreateFrame("Frame", nil, frame, "BackdropTemplateForeverAuras")
