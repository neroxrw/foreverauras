...
local function Constructor()
  ...
  background:SetBackdrop({
     bgFile = "Interface\\AddOns\\ForeverAuras\\Media\\Textures\\Square_FullWhite.tga",
     edgeFile = "Interface\\AddOns\\ForeverAuras\\Media\\Textures\\Square_FullWhite.tga",
     tile = true,
     tileEdge = true,
     --tileSize = 8,
     edgeSize = 2
  ...
  for _, direction in ipairs(directions) do
    ...
    buttonTex:SetTexture("Interface\\AddOns\\ForeverAuras\\Media\\Textures\\Square_FullWhite.tga")
