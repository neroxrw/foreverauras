...
local function Constructor()
  ...
  update:SetNormalTexture([[Interface\AddOns\ForeverAuras\Media\Textures\wagoupdate_refresh.tga]])
  update:Disable()
  update:SetWidth(24)
  update:SetHeight(24)
  ...
  tex:SetTexture([[Interface\AddOns\ForeverAuras\Media\Textures\wagoupdate_logo.tga]])
  tex:SetAllPoints()
  updateLogo.tex = tex
