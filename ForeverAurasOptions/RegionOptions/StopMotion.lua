...
local function modifyThumbnail(parent, region, data, fullModify, size)
    ...
    local texture = data.foregroundTexture or "Interface\\AddOns\\ForeverAuras\\Media\\Textures\\stopmotion";
...
local function createIcon()
    local data = {
        height = 30,
        width = 30,
        foregroundTexture = "Interface\\AddOns\\ForeverAuras\\Media\\Textures\\stopmotion",
