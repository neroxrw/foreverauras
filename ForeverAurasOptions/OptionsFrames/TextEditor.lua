...
local function ConstructTextEditor(frame)
  ...
  if (fontPath) then
    editor.editBox:SetFont(fontPath, ForeverAurasSaved.editor_font_size, "")
  end
      ...
      LibDD:UIDropDownMenu_AddButton(
        {
          ...
          isNotRadio = true,
          checked = function()
            return ForeverAurasSaved.editor_bracket_matching
          end,
          func = function()
            ForeverAurasSaved.editor_bracket_matching = not ForeverAurasSaved.editor_bracket_matching
          end
        },
      level)
      LibDD:UIDropDownMenu_AddButton(
        ...
        LibDD:UIDropDownMenu_AddButton(
          {
            ...
            isNotRadio = false,
            checked = function()
              return ForeverAurasSaved.editor_tab_spaces == i
            end,
            func = function()
        ...
        LibDD:UIDropDownMenu_AddButton(
          {
            ...
            isNotRadio = false,
            checked = function()
              return ForeverAurasSaved.editor_font_size == i
            end,
            func = function()
              ForeverAurasSaved.editor_font_size = i
              editor.editBox:SetFont(fontPath, ForeverAurasSaved.editor_font_size, "")
            end
          },
        level)
  ...
  ForeverAurasOptionsSaved.savedSnippets = ForeverAurasOptionsSaved.savedSnippets or {}
  local savedSnippets = ForeverAurasOptionsSaved.savedSnippets
  ...
  editor.editBox:HookScript(
    "OnChar",
    function(_, char)
      if not IsControlKeyDown() and ForeverAurasSaved.editor_bracket_matching then
        if char == "(" then
