...
local function ConstructMover(frame)
  ...
  arrowTexture:SetTexture("Interface\\Addons\\ForeverAuras\\Media\\Textures\\offscreen.tga")
...
AlignmentLines.CreateLines = function(self, data, sizerPoint)
  ...
  local align = (ForeverAurasOptionsSaved.magnetAlign and not IsShiftKeyDown())
                    or (not ForeverAurasOptionsSaved.magnetAlign and IsShiftKeyDown())
  if align then
