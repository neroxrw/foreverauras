    ...
    options[key .. "collapseButton"] = {
      ...
      image = function()
        if notcollapsable then
          return "Interface\\AddOns\\ForeverAuras\\Media\\Textures\\bullet1", 18, 18
        else
          return isCollapsed() and "Interface\\AddOns\\ForeverAuras\\Media\\Textures\\expand"
...
OptionsPrivate.AddCollapsibleHeader = addCollapsibleHeader
